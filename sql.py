...
try:
    ...
    try:
        ...
        #    create_table_query = "CREATE TABLE `userss`(id int AUTO_INCREMENT," \
         #                      " name varchar(32)," \
         #                       " password varchar(32)," \
        ...
        # insert data
        with connection.cursor() as cursor:
            insert_query = "INSERT INTO `userss` (name, password, email) VALUES ('Anna2', 'qwerty', 'anna@gmail.com');"
        ...
        with connection.cursor() as cursor:
            select_all_rows = "SELECT * FROM `userss`"
